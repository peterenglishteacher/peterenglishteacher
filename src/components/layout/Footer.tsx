      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-blue-300 text-sm">{CONTACT.domain}</p>
          </div>
          ...
          {/* Legal placeholder */}
          <div className="space-y-3">
            <a href="#" className="block text-blue-300 hover:text-white text-sm transition-colors">
        ...
        <div className="border-t border-blue-900 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-blue-300 text-sm">{content.copyright}</p>
